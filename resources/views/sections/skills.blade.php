            ...
            <div class="art-a art-service-icon-box">
                <div class="art-service-ib-content">
                    ...
                    <div>Code cross-platfom mobile apps using a single codebase by leveraging technologies like <a
                            ...
                            href="https://flutter.dev" class="skill-link skill-color-link" data-no-swup
                            target="_blank">Flutter</a>,
                        and IDE such as <a href="https://developer.apple.com/xcode" class="skill-link skill-color-link"
                            data-no-swup target="_blank">Xcode</a> and <a href="https://developer.android.com/studio"
                            class="skill-link skill-color-link" data-no-swup target="_blank">Android Studio</a> for
            ...
            <div class="art-a art-service-icon-box">
                <div class="art-service-ib-content">
                    ...
                    <div>Write server-side application code using <a href="https://nodejs.org/en"
                        ...
                        user authentication, data processing and chat using modern architectural patterns.</div>
                </div>
            </div>
        </div>
        <!-- Single Skills -->
                ...
                <div class="art-service-ib-content">
                    ...
                    <div>
                        Process mobile and web application data using <a href="https://www.mysql.com/"
                            ...
                            class="skill-link skill-color-link" data-no-swup target="_blank">mongoDB</a> to ensure
